...
import com.tompee.utilities.knowyourmeds.core.database.converters.InteractionPairListConverter
import com.tompee.utilities.knowyourmeds.core.database.converters.MarketDrugListConverter
import com.tompee.utilities.knowyourmeds.core.database.converters.MedicineListConverter
...
@TypeConverters(MedicineTypeConverter::class, StringListConverter::class, MarketDrugListConverter::class,
        MedicineListConverter::class, InteractionPairListConverter::class)
